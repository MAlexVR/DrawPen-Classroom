...
export const minWhiteboardWidth = 350;
export const minWhiteboardHeight = 350;
...
export const createApplicationColorList = (colorPalette) => {
  ...
  return [
    ...
    ...toolbarColorIds.map((colorId) => {
      const color = colorPalette[colorId] || toolbarColorFallbacks[colorId];

      return {
        id: colorId,
        color: color,
        title: colorId === 'color_custom' ? 'Custom Color' : ntc.name(color)[1],
